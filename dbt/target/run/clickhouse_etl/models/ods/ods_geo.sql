        ...
        insert into `ods`.`geo_data`
        ("click_id", "geo_latitude", "geo_longitude", "geo_country", "geo_timezone", "geo_region_name", "ip_address", "kafka_offset", "kafka_partition", "kafka_timestamp", "raw_load_time", "ods_load_time")
